  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 no-print gradient-primary text-primary-foreground px-6 py-3 rounded-full font-semibold flex items-center gap-2 shadow-lg"
      >
        ...
        >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={() => setShowDialog(false)}
                className="w-8 h-8 rounded-full glass flex items-center justify-center hover:bg-destructive/20"
              >
            ...
            <div className="flex gap-2 mb-4">
              <button
                onClick={selectAll}
                className="flex-1 px-4 py-2 glass rounded-lg text-secondary-foreground hover:bg-primary/20"
              >
                Pilih Semua
              </button>
              <button
                onClick={deselectAll}
                className="flex-1 px-4 py-2 glass rounded-lg text-secondary-foreground hover:bg-destructive/20"
              >
                Hapus Semua
              </button>
            </div>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setShowDialog(false)}
                className="flex-1 px-6 py-3 glass rounded-xl text-secondary-foreground font-semibold hover:bg-destructive/20"
              >
                Batal
              </button>
              <button
      ...
      {isPrinting && (
        <div className="fixed inset-0 bg-navy/90 backdrop-blur-sm z-[100] no-print flex items-center justify-center">
...
const CoverSlide = () => (
  ...
  >
    ...
    <div className="relative z-10 text-center max-w-5xl mx-auto pt-16">
      ...
      <h2 className="text-2xl md:text-4xl font-display text-secondary-foreground mb-8">
        Smart Construction One Platform
      </h2>

      <div className="glass-dark rounded-2xl p-6 md:p-8 mb-8 max-w-3xl mx-auto relative overflow-hidden">
        <p className="text-xl md:text-2xl text-secondary-foreground leading-relaxed relative z-10">
          "Membangun Masa Depan yang{" "}
          <span className="font-semibold text-primary">Terjangkau</span>,{" "}
          <span className="font-semibold text-primary">Transparan</span>, dan{" "}
          <span className="font-semibold text-primary">Terpercaya</span>"
        </p>
      </div>

      <p className="text-lg md:text-xl text-secondary-foreground/80 mb-12">
        One-Stop Solution untuk Ekosistem Konstruksi Indonesia
      </p>

      <div className="flex flex-col md:flex-row gap-4 justify-center items-center text-secondary-foreground/60 text-sm">
        <span>Presented by: Fajar Iryanto Putra | Ahri Suwandi | Muhamad Ikbal</span>
        <span className="hidden md:block">•</span>
        <span>BTN Housing Preneur 2025</span>
      </div>
    </div>
  </section>
);
      ...
      <div className="max-w-7xl mx-auto pt-16">
        <div>
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-destructive/10 text-destructive text-sm font-medium mb-3">
              INSPIRATION
            </span>
          ...
          <div className="glass-dark rounded-2xl p-6 md:p-8 mb-12 max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {problems.map((problem, i) => (
              ...
              >
                <div className={`w-14 h-14 rounded-xl ${problem.bgColor} flex items-center justify-center mb-3`}>
          ...
          <div className="bg-destructive/10 border border-destructive/20 rounded-2xl p-6 text-center mb-8">
            <p className="text-lg md:text-xl text-foreground">
              ...
              <span className="text-destructive font-semibold">"tertipu"</span> atau{" "}
              <span className="text-destructive font-semibold">"dirugikan"</span> dalam proses konstruksi
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {untapped.map((item, i) => (
                <div
                  key={i}
                  className="bg-card/10 border border-primary/30 rounded-2xl p-6"
                >
...
const SolutionSlide = () => {
  ...
  return (
    <section id="slide-4" className="slide min-h-screen gradient-surface py-16 md:py-24 px-4 relative print:min-h-0 print:h-auto print:page-break-after-always">
      <LogoBar /><div className="max-w-7xl mx-auto pt-16">
    <div>
      <div className="text-center mb-12">
        <span className="inline-block px-4 py-1 rounded-full bg-success/10 text-success text-sm font-medium mb-3">
          IDEATION
        </span>
        <h2 className="text-3xl md:text-5xl font-display font-bold text-foreground mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {pillars.map((pillar, i) => (
          <div
            ...
            className="bg-card rounded-2xl p-6 shadow-card border border-border/50"
          >
            <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${pillar.color} flex items-center justify-center mb-3`}>
    ...
    <div>
      ...
      <div className="glass rounded-2xl p-6 mb-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3 text-sm text-secondary-foreground/80">
          {["Smart Contracts", "NFT Marketplace", "Immutable Certificates", "Transparent History"].map((item, i) => (
            <span key={i} className="px-3 py-1 glass rounded-full">
              {item}
            </span>
          ))}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {platforms.map((platform, i) => (
          ...
          >
            <div className={`w-14 h-14 ${platform.color} rounded-xl flex items-center justify-center mb-3`}>
            ...
            <ul className="space-y-2">
              {platform.features.slice(0, 5).map((feature, j) => (
                <li key={j} className="flex items-center gap-2 text-secondary-foreground/80 text-sm">
              ...
              <div className="mt-4 pt-4 border-t border-secondary-foreground/10">
                ...
                <div className="flex flex-wrap gap-1">
                  {platform.tiers.map((tier, j) => (
                    <span key={j} className={`${tier.color} text-xs px-2 py-1 rounded text-secondary-foreground`}>
                      {tier.name}
                    </span>
                  ))}
                </div>
...
<LogoBar />
  <div className="max-w-7xl mx-auto pt-16">
    <div>
      <div className="text-center mb-12">
        <span className="inline-block px-4 py-1 rounded-full bg-info/10 text-info text-sm font-medium mb-3">
...
<LogoBar />
  <div className="max-w-7xl mx-auto pt-16">
    <div>
      ...
      <div className="glass-dark rounded-2xl p-6 mb-8 text-center">
          ...
          <div key={i} className="glass rounded-2xl p-5">
            ...
            <ul className="space-y-1 mb-3">
              {impact.points.map((point, j) => (
                <li key={j} className="flex items-start gap-2 text-secondary-foreground/80 text-sm">
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 text-secondary-foreground/80 text-sm">
          {[
            ...
            <div key={i} className="flex items-center">
              <span className="px-3 py-1 bg-navy-light rounded-full">
                {item}
              </span>
              {i < 7 && <Icon path={mdiArrowRight} size={0.8} className="text-primary mx-1" />}
            </div>
          ))}
          <span className="px-4 py-2 gradient-primary text-primary-foreground rounded-full font-bold">
            EVERYONE WINS
          </span>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {milestones.map((milestone, i) => (
            <div key={i} className="glass rounded-xl px-4 py-3 text-center min-w-[150px]">
              <div className="font-display font-bold text-primary">{milestone.year}</div>
              <p className="text-secondary-foregroun/80 text-xs">{milestone.desc}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="glass rounded-2xl p-6 mb-8">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          {beyondConstruction.map((item, i) => (
            <div key={i} className="flex items-center gap-2 px-4 py-2 bg-navy-light rounded-full text-secondary-foreground">
      ...
      <div className="gradient-primary rounded-3xl p-8 text-center mb-8 relative overflow-hidden">
        <h3 className="text-2xl md:text-4xl font-display font-bold text-primary-foreground mb-3 relative z-10">
          SCOP
        </h3>
      ...
      <div className="text-center text-secondary-foreground/60 text-sm">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-3">
          {[
            { icon: mdiEmail, text: "hello@SCOP.id" },
            { icon: mdiPhone, text: "+62 21 1234 5678" },
          ].map((contact, i) => (
        ...
        <p>@SCOP.id | Demo available upon request</p>
      </div>
    </div>
  </div>
</section>
